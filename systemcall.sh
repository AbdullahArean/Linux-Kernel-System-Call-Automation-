...
# sed -i /^core-y +=/ s/$/ $2\//" Makefile
# sed -i "\$i asmlinkage long sys_$2(void) ;" include/linux/syscalls.h
# sed -i "/^334.*/a 335 common  $2        sys_$2" arch/x86/entry/syscalls/syscall_64.tbl
